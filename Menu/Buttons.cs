    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods
                ...
                new ButtonInfo { buttonText = "SpeedBoost", method =() => SpeedBoost.SpeedBoostMod(), toolTip = "Make you go brrrr. UND", isTogglable = true},
                new ButtonInfo { buttonText = "Fly", method =() => Fly.FlyMod(), toolTip = "Makes you flyyyyy. UND", isTogglable = true},
                new ButtonInfo { buttonText = "Noclip", method =() => Noclip.NoClipMod(), toolTip = "Makes you phase through stuff. UND", isTogglable = true},
                new ButtonInfo { buttonText = "CarMonke", method =() => CarMonke.CarMonkeMod(), toolTip = "Make you go brrrr on da ground. UND", isTogglable = true},
